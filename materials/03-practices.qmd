...
-   [*The Turing Way*](https://book.the-turing-way.org/) is indeed a compendium of guides on open science, reproducibility, and research ethics, among other interesting topics. Have a look at the Guide for Reproducible Research [@turingway2025].
...
[@alston2021] outlined basic steps toward making research more reproducible base on three stages of a research project: (1) **before** analysis, (2) **during** analysis, and (3) **after** analysis. 
