...
The core of the slide deck is built around the "Turing Way" matrix (@fig-matrix), which deconstructs the definition of reproducibility and replicability based on changes in **data** and **analysis**, similarly to others [@nust2018], [@kekedron2021gean], [@NAP2019].
