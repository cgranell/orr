...
The course content is organised in different teaching chapters/units. It is not intended to follow the chaptre in a particular order, but it is recommended to start with the first unit and then choose the next ones depending on your needs and interests. The following flowchart gives you an idea of how the chapter are connected and how you can navigate through them.:

```{mermaid}
flowchart TB
  A[Foreword] --> B(1. Intro)
  B --> C{Role?}
